...
### kss ###
dataset = "moon"
data_path = os.path.join("/content/drive/MyDrive/korean-fastspeech2", dataset)
meta_name = "new_meta.txt"	# "transcript.v.1.4.txt" or "transcript.v.1.3.txt"
textgrid_path="/content/drive/MyDrive/korean-fastspeech2/"
textgrid_name = "moon_textgrid.zip"
